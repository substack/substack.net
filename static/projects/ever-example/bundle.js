...
require.define("/index.js",function(require,module,exports,__dirname,__filename,process){module.exports = function (elem) {
...
require.define("/init.json",function(require,module,exports,__dirname,__filename,process){module.exports = {
  "initEvent" : [
    "type",
    "canBubble", 
    "cancelable"
...
require.define("/types.json",function(require,module,exports,__dirname,__filename,process){module.exports = {
  "MouseEvent" : [
    "click",
    "mousedown",
    "mouseup",
...
require.define("/example/main.js",function(require,module,exports,__dirname,__filename,process){var ever = require('../');
