...
require.define("/node_modules/swoop/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index.js"}});

require.define("/node_modules/swoop/index.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/browser.js",function(require,module,exports,__dirname,__filename,process){var swoop = require('swoop');
...
var files = [
    ...
    'demo.png#https://github.com/substack/nodeconf-browserify-2012/tree/master/example/bundle',
    ...
    'demo.png#https://github.com/substack/nodeconf-browserify-2012/tree/master/example/stream',
    
    'testling.png',
    'demo.png#https://github.com/substack/nodeconf-browserify-2012/tree/master/example/testling',
...
var sw = swoop(files.reduce(function (acc, file, ix) {
    ...
    if (file.split('#')[0] === 'demo.png') {
        var link = document.createElement('a');
        link.setAttribute('href', file.split('#')[1]);
        link.addEventListener('click', function (ev) {
            ev.stopPropagation();
            console.log('CLICK');
        });
        link.className = 'example';
        link.appendChild(document.createTextNode('[ example code ]'));
